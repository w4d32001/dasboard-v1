...
export default function CardSummary(props: CardSummaryProps){
  ...
  return (
    <div className='shadow-sm bg-background rounded-lg p-5 py-3 hover:shadow-lg transition dark:bg-gray-900 dark:text-white'>
      ...
      <div className='flex gap-4 mt-2 md:mt-4'>
        ...
        <div className={cn(`flex items-center gap-1 px-2 text-xs text-white rounded-lg h-[20px] bg-black dark:bg-gray-500`)}>
          {average}%
          {
            average < 20 && (
